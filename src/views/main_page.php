        ...
        <div class="row justify-content-center">
            ...
            <div class="col-12 col-md-8 menu margin-top_8--sm">
                <ul>
                    ...
                    <li>
                        <a href="#offcanvasPersonaje" role="button" tabindex="1"><svg xmlns="http://www.w3.org/2000/svg" width="21" height="21" fill="currentColor" class="bi bi-person-square" viewBox="0 0 16 16" data-bs-toggle="offcanvas" aria-controls="offcanvasPersonaje">
                                <path d="M11 6a3 3 0 1 1-6 0 3 3 0 0 1 6 0z" />
