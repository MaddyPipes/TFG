    ...
    <main>
        ...
        <nav class="container">
            <div class="row justify-content-around">
                <div class="col-5 menu d-flex justify-content-center" style="height: 30em;">
                    <a href="#offcanvasPersonaje" role="button" tabindex="1" data-bs-toggle="offcanvas" aria-controls="offcanvasPersonaje" class="text-light text-decoration-none d-flex flex-column"><svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" class="bi bi-person-square" viewBox="0 0 16 16">
                            <path d="M11 6a3 3 0 1 1-6 0 3 3 0 0 1 6 0z" />
                            <path d="M2 0a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2H2zm12 1a1 1 0 0 1 1 1v12a1 1 0 0 1-1 1v-1c0-1-1-4-6-4s-6 3-6 4v1a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1h12z" />
                        </svg>Personaje</a>
                </div>
                <div class="col-5 menu d-flex justify-content-center" style="height: 30em;">
                    <a href="#offcanvaSalas" role="button" tabindex="1" data-bs-toggle="offcanvas" aria-controls="offcanvaSalas" class="text-light text-decoration-none d-flex flex-column"><svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" class="bi bi-door-open-fill" viewBox="0 0 16 16">
                ...
                <div class="container mx-auto mt-4">
                    <div class="row" id="listaPJ">
                        <?php for ($i = 0; $i < count($personajes); $i++) : ?>
                            <div class="margin-bottom_16" id="recuadroPJ<?= $personajes[$i]["idPERSONAJE"] ?>">
                            ...
                            <div class="align-self-center d-none cartaPJ" id="cartaPJ<?= $personajes[$i]["idPERSONAJE"] ?>">
                                <div class="card" style="width: 18rem;">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form action="../controller/crearPersonajeModelo.php" class="d-inline" method="POST">
